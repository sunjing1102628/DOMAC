...
directory1 = "./results/final_results54new_3e4_0.950110acc/"
#directory1 = "./results/final_results51new1/"
directory2 = "./results/final_results72new_2.5e45e4_0.95acc/"
#directory2 = "./results/final_results54new5e51e4/"
directory3 = "./results/final_results54new_3e4_0.95ids/"
directory4 = "./results/final_results54new_3e4/"
# directory4 = "./results/final_results54new_3e4_0.95_clip10/"
directory5 = "./results/final_results52new_3e4_0.95ids/"
directory6 = "./results/final_results53new_3e4_0.95ids/"
...
for madacopp2_file in madacopp1_files:
...
base_line1, = ax.plot(x_train, mean_train, 'tab:blue', label= "maac")
base_line2, = ax.plot(x_test, mean_test, 'tab:red',label= 'maac_ids')
#base_line3, = ax.plot(x_madac, mean_madac, "olive",label= "maac_oppQR_ids")
#base_line4, = ax.plot(x_madacopp, mean_madacopp, "purple",label= "maac_oppQR")
base_line5, = ax.plot(x_madacopp1, mean_madacopp1, "green",label= "maac_oppids")
base_line6, = ax.plot(x_madacopp2, mean_madacopp2, "cyan",label= "maac_QRids")
