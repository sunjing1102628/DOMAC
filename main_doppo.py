    ...
    for seed in seeds:
        ...
        while episode < n_episodes:
            ...
            if all(done_n):
                ...
                np.savetxt('./results/doppo4v2/train_score_seed_{}.csv'.format(seed), np.array(log_mean),
                           delimiter=";")
                np.savetxt('./results/doppo4v2/train_score_std_seed_{}.csv'.format(seed), np.array(log_std),
                           delimiter=";")
