...
class MAAC_OPP:
    def __init__(self, args,seed):  # 因为不同的agent的obs、act维度可能不一样，所以神经网络不同,需要agent_id来区分
        ...
        self.opp_agents=args.opp_agents
        #print('opp_agent',args.opp_agents)
        self.opp_sample_num= args.opp_sample_num
       # print('self.opp_sample_num',self.opp_sample_num)
