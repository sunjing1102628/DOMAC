...
class Mixing_Network(nn.Module):
    ...
    def forward(self, q_values, hyper_pars):
        ...
        print('test1',torch.bmm(x, hyper_pars['w2']))
        print('test2', hyper_pars['b2'])
        ...
        output = torch.bmm(x, hyper_pars['w2']) + hyper_pars['b2'] # (m, N_ACTIONS, N_QUANT)
        print('output',output)
        return output.view(-1)
        #return output.view(-1), tau
