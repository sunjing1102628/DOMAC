...
class PPO(nn.Module):
    ...
    def train_net(self):
        s, a, r, s_prime, done_mask, prob_a = self.make_batch() #torch.Size([15, 1])
        #print('done_mask',done_mask.size())
        ...
        for i in range(K_epoch):
            ...
            #print('advantage_lst11',advantage_lst)
            ...
            pi_a = pi.gather(1, a)#torch.Size([20, 1])
            print('pi_a',torch.log(pi_a) )
            print('prob_a',torch.log(prob_a))
