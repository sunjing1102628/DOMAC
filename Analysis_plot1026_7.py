...
directory1 = "./results/final_results71new_2.5e45e4_0.95ids2/"

#directory2 = "./results/final_results73new_2.5e45e4_0.95ids/"
#directory2 = "./results/final_results54new5e51e4/"
#directory3 = "./results/final_results72new_2.5e45e4_0.95/"
directory4 = "./results/final_results72new_2.5e45e4_0.95ids/"
# directory4 = "./results/final_results54new_3e4_0.95_clip10/"
directory5 = "./results/final_results73new_2.5e45e4_0.95ids/"
...
pd_madacopp2_mean = pd_madacopp2_gb.mean()
...
pd_madacopp1_mean = pd_madacopp1_gb.mean()
...
#base_line3, = ax.plot(x_madac, mean_madac, "olive",label= "maac_opp_ids")
...
base_line6, = ax.plot(x_madacopp2, mean_madacopp2, "red",label= "MAAC_OPPQR")
